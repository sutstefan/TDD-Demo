...
//  ToDoTests
//
//  Created by Stefan Sut on 11/2/17.
...
class APIClientTests: XCTestCase {
    ...
    func test_Login_UsesExpectedURL() {
        ...
        sut.loginUser(withName: "dasd$m", password: "%&34", completion: completion)
        ...
        guard let expectedUsername = "dasd$m".addingPercentEncoding(withAllowedCharacters: allowedCharacters) else { fatalError() }
    ...
    func test_Login_WhenSuccessful_CretesToken() {
        let sut = APIClient()
    ...
    func test_Login_WhenResonseHasError_ReturnsError() {
        let sut = APIClient()
